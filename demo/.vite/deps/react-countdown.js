...
var Countdown = function(_React$Component) {
	_inherits(Countdown$2, _React$Component);
	var _super = _createSuper(Countdown$2);
	function Countdown$2() {
		var _this;
		_classCallCheck(this, Countdown$2);
...
var Countdown$1 = function(_React$Component) {
	_inherits(Countdown$1$1, _React$Component);
	var _super = _createSuper(Countdown$1$1);
	function Countdown$1$1(props) {
		var _this;
		_classCallCheck(this, Countdown$1$1);
		...
		_this.tick = function() {
			var timeDelta$1 = _this.calcTimeDelta();
			var callback = timeDelta$1.completed && !_this.props.overtime ? void 0 : _this.props.onTick;
			_this.setTimeDeltaState(timeDelta$1, void 0, callback);
		};
		...
		_this.start = function() {
			...
			var timeDelta$1 = _this.calcTimeDelta();
			_this.setTimeDeltaState(timeDelta$1, "STARTED", _this.props.onStart);
			if (!_this.props.controlled && (!timeDelta$1.completed || _this.props.overtime)) {
				_this.clearTimer();
...
//#endregion
export { calcTimeDelta, index_es_default as default, formatTimeDelta, zeroPad };
